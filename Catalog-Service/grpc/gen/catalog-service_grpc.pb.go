...
func (c *catalogServiceClient) GetItem(ctx context.Context, in *ID, opts ...grpc.CallOption) (*Item, error) {
...
func (UnimplementedCatalogServiceServer) GetItem(context.Context, *ID) (*Item, error) {
...
func _CatalogService_GetItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CatalogServiceServer).GetItem(ctx, req.(*ID))
	}
