...
const file_proto_catalog_service_proto_rawDesc = "" +
	"\n" +
	"\x1bproto/catalog-service.proto\x12\x0ecatalogservice\"\x14\n" +
	"\x02ID\x12\x0e\n" +
	...
	"\x05price\x18\x04 \x01(\x02R\x05price2E\n" +
	"\x0eCatalogService\x123\n" +
	"\aGetItem\x12\x12.catalogservice.ID\x1a\x14.catalogservice.ItemB\n" +
...
var file_proto_catalog_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_catalog_service_proto_goTypes = []any{
	(*ID)(nil),   // 0: catalogservice.ID
	(*Item)(nil), // 1: catalogservice.Item
}
var file_proto_catalog_service_proto_depIdxs = []int32{
	0, // 0: catalogservice.CatalogService.GetItem:input_type -> catalogservice.ID
	1, // 1: catalogservice.CatalogService.GetItem:output_type -> catalogservice.Item
